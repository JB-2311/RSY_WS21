...
p0=[-346 mittelP_y-versatz_y mittelP_z-versatz_z];
p1=[-346 mittelP_y-versatz_y mittelP_z+versatz_z];
p2=[-346 mittelP_y+versatz_y mittelP_z+versatz_z];
p3=p0;
p4=[-346 mittelP_y+versatz_y mittelP_z-versatz_z];
p5=p1; 
p6=[-346 mittelP_y mittelP_z+2*versatz_z];
%p6=[346 mittelP_y 362];
p7=p2;
p8=p4;
